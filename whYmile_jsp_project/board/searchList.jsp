...
<body>
	<%
		...
		ArrayList<BoardDTO> boardList = boardDAO.getSearchList(pageNumber, selected, search); // 검색된 게시글 리스트
	...
	<div class="container">
		<div class="board-list">
			<div class="board-header">
				<div>
					whYmile | "${search }" 검색 결과 (${searchBoardTotal })
		...
		<c:if test="${boardList.size() == 0 }">
			...
			<hr style="margin-top: 0px; margin-bottom: 15px; width: 1140px">
				<div style="font-size:30px; font-weight: bold; color: rgba(79,79,79,0.6);">게시글이 존재하지 않습니다.</div>
			</div>
		</c:if>
		<c:if test="${boardList.size() != 0 }">
			<div class="board-main">
		...
		<div class="lowArea">
			<select id="searchVal" name="searchVal" class="searchSelect">
				...
				<option value="내용" <%if (selected.equals("내용")) {%>selected<%} %>>내용</option>
